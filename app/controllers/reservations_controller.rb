class ReservationsController < ApplicationController
  ...
  # PATCH/PUT /reservation/activities
  def update_activity_preference
    old = params[:old].to_i
    changed = params[:changed].to_i
    @reservation = current_user.reservation
    @reservation.swap_activity_positions(old, changed)
    @reservation.save
  ...
  private
    ...
    def reservation_params
      params.require(:reservation).permit(:user_id, :first_name, :last_name, :guests_adults, :guests_children, :attending, :attending_friday, :attending_saturday, :attending_sunday, :staying_onsite, :accommodation_rv, :accommodation_camper, :accommodation_tent, :accommodation_cabin, :accommodation_hotel, :cabin_number, :cabin_mate_request, :cabin_own_linens, :cabin_own_linens_description, :hotel_name, :designated_driver_plan, :food_allergies, :dietary_preferences, :additional_comments, :guest_names, :meal_friday_dinner, :meal_saturday_breakfast, :meal_saturday_lunch, :meal_saturday_dinner, :meal_saturday_snack, :meal_sunday_brunch, :optional_completed, :activity_preference_paint_night, :activity_preference_archery, :activity_preference_climbing_wall, :activity_preference_gokarts, :activity_preference_slipnslide, :activity_preference_swimming_pool, :activity_preference_zipline)
    end
end
