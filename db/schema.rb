...
ActiveRecord::Schema[7.0].define(version: 2023_07_25_164351) do
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.string "cabin_own_linens", default: "no"
    t.string "hotel_name"
    ...
    t.string "cabin_linens_disclaimer"
    t.string "cabin_mate_names"
